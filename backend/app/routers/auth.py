...
from backend.app.schemas.auth import LoginRequest, RefreshRequest, TokenResponse, UserCreate, UserOut
...
def login(body: LoginRequest, request: Request, db: Session = Depends(get_db)):
    ...
    user = auth_service.authenticate(db, body.email, body.password, ip=ip)
